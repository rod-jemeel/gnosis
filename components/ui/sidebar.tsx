...
function SidebarGroupAction({
  ...
  return useRender({
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-1.5 right-2 h-5 w-5 rounded-none p-0 focus-visible:ring-2 [&>svg]:size-3.5 flex items-center justify-center outline-hidden transition-transform [&>svg]:shrink-0 after:absolute after:-inset-2 md:after:hidden group-data-[collapsible=icon]:hidden",
          className
        ),
      },
      props
...
function SidebarMenuButton({
  ...
  // With tooltip: use TooltipTrigger with render prop for proper composition
